# Generated by Powerlevel10k configuration wizard on 2024-07-30 at 00:08 EDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VIOWR}_FOREGROUND=118
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIOWR_CONTENT_EXPANSION='hi▶'
  ...
  typeset -g POWERLEVEL9K_DIR_BACKGROUND='#423B7A'
  ...
  typeset -g POWERLEVEL9K_VCS_{CLEAN,STAGED,UNSTAGED,COMMITS_AHEAD,COMMITS_BEHIND,UNTRACKED,CONFLICTED,MODIFIED}_BACKGROUND='#111111'
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE_BACKGROUND='#222222'
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR_BACKGROUND='#BF382E'
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR_SIGNAL_BACKGROUND='#BF382E'
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_FOREGROUND='#D2D7EE'
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_BACKGROUND='#242424'
  ...
  typeset -g POWERLEVEL9K_VI_MODE_NORMAL_BACKGROUND=13
  # Text and color for visual vi mode.
  typeset -g POWERLEVEL9K_VI_VISUAL_MODE_STRING=VISUAL
  typeset -g POWERLEVEL9K_VI_MODE_VISUAL_FOREGROUND=13
  typeset -g POWERLEVEL9K_VI_MODE_VISUAL_BACKGROUND=13
  # Text and color for overtype (a.k.a. overwrite and replace) vi mode.
  typeset -g POWERLEVEL9K_VI_OVERWRITE_MODE_STRING=OVERTYPE
  typeset -g POWERLEVEL9K_VI_MODE_OVERWRITE_BACKGROUND=3
  # Text and color for insert vi mode.
  typeset -g POWERLEVEL9K_VI_INSERT_MODE_STRING='yes'
